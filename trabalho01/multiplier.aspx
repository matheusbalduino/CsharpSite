<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="multiplier.aspx.cs" Inherits="trabalho01.WebForm1" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="container1"> 
          ...
          <div class="mb-3 form-label">
                ...
                <asp:TextBox ID="txtRes" runat="server" CssClass="form-control"></asp:TextBox>
          </div>
    
        <asp:Button ID="btnCalc"  Text="calcular" runat="server" CssClass="btn-success" OnClick="btnCalc_Click" />
